...
<table>
    ...
    <tr>
     ...
     <br> Для снижения трудозатрат разработан пайплайн, который сначала считывает данные с измерительного оборудования, проводит разметку датчиков годные/бракованные, строит ключевые распределения и выводит сводный pdf-отчет.  </td>
    ...
    <tr>
      ...
      <br> Здесь сначала считываем и преобразовываем из формата комплексных чисел данные с измерительного оборудования, затем проводим свертку сигналов во частотной области и с помощью обратного Фурье-преобразования переходим во временную область. Интерполируя временную область с пиковыми значениями рассчитываем необходимый функционал изделия. </td>
        <td> предобработка данных, свертка, интерполяция </td>
